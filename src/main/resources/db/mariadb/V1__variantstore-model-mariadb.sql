...
-- -----------------------------------------------------
-- Schema variantstore_db
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `variantstore_db` ;

-- -----------------------------------------------------
-- Schema variantstore_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `variantstore_db` DEFAULT CHARACTER SET utf8 ;
USE `variantstore_db` ;

-- -----------------------------------------------------
-- Table `variantstore_db`.`gene`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`gene` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`gene` (
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`variant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`variant` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`variant` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`consequence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`consequence` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`consequence` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`referencegenome`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`referencegenome` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`referencegenome` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`annotationsoftware`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`annotationsoftware` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`annotationsoftware` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`project`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`project` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`project` (
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`entity`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`entity` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`entity` (
  `id` VARCHAR(15) NOT NULL,
  ...
  CONSTRAINT `fk_Case_Project1`
    ...
    REFERENCES `variantstore_db`.`project` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`variantcaller`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`variantcaller` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`variantcaller` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `version` VARCHAR(30) NOT NULL,
  `doi` VARCHAR(30) NOT NULL,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`sample`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`sample` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`sample` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_Sample_Case1`
    ...
    REFERENCES `variantstore_db`.`entity` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`annotationsoftware_has_consequence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`annotationsoftware_has_consequence` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`annotationsoftware_has_consequence` (
  ...
  CONSTRAINT `fk_AnnotationSoftware_has_Consequence_AnnotationSoftware1`
    ...
    REFERENCES `variantstore_db`.`annotationsoftware` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AnnotationSoftware_has_Consequence_Consequence1`
    FOREIGN KEY (`consequence_id`)
    REFERENCES `variantstore_db`.`consequence` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`variant_has_referencegenome`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`variant_has_referencegenome` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`variant_has_referencegenome` (
  ...
  UNIQUE INDEX `idx_variant_rg_unique` (`variant_id` ASC, `referencegenome_id` ASC),
  CONSTRAINT `fk_Variant_has_ReferenceGenome_Variant1`
    FOREIGN KEY (`variant_id`)
    REFERENCES `variantstore_db`.`variant` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Variant_has_ReferenceGenome_ReferenceGenome1`
    FOREIGN KEY (`referencegenome_id`)
    REFERENCES `variantstore_db`.`referencegenome` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`variant_has_consequence`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`variant_has_consequence` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`variant_has_consequence` (
  `variant_id` INT NOT NULL,
  `consequence_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`variant_has_variantcaller`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`variant_has_variantcaller` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`variant_has_variantcaller` (
  ...
  CONSTRAINT `fk_Variant_has_VariantCaller_VariantCaller1`
    ...
    REFERENCES `variantstore_db`.`variantcaller` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`ensembl`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`ensembl` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`ensembl` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `version` INT NULL,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`consequence_has_gene`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`consequence_has_gene` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`consequence_has_gene` (
  `consequence_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_Consequence_has_Gene_Gene1`
    FOREIGN KEY (`gene_id`)
    REFERENCES `variantstore_db`.`gene` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`ensembl_has_gene`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`ensembl_has_gene` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`ensembl_has_gene` (
  ...
  CONSTRAINT `fk_Ensembl_has_Gene_Ensembl1`
    ...
    REFERENCES `variantstore_db`.`ensembl` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`vcfinfo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`vcfinfo` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`vcfinfo` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`genotype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`genotype` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`genotype` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `variantstore_db`.`sample_has_variant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `variantstore_db`.`sample_has_variant` ;

CREATE TABLE IF NOT EXISTS `variantstore_db`.`sample_has_variant` (
  ...
  UNIQUE INDEX `idx_svvg_unique` (`sample_id` ASC, `variant_id` ASC, `vcfinfo_id` ASC, `genotype_id` ASC),
  INDEX `idx_sample_variant` (`sample_id` ASC, `variant_id` ASC),
  INDEX `idx_variant_sample` (`variant_id` ASC, `sample_id` ASC),
  ...
  CONSTRAINT `fk_sample_has_variant_vcfinfo1`
    ...
    REFERENCES `variantstore_db`.`vcfinfo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sample_has_variant_genotype1`
    FOREIGN KEY (`genotype_id`)
    REFERENCES `variantstore_db`.`genotype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sample_has_variant_sample1`
    FOREIGN KEY (`sample_id`)
    REFERENCES `variantstore_db`.`sample` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
